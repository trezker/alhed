...
function New_map_interface:init ()
	...
	self.cancel.button:init("Cancel", self.cancel_cb, self)
	...
	self.create.button:init("Create", self.create_cb, self)
	...
	self.sizex_spinner:init(self.sizex_spinner_callback, self)
	...
	self.sizez_spinner:init(self.sizez_spinner_callback, self)
	...
	self.tilesize_spinner:init(self.tilesize_spinner_callback, self)
